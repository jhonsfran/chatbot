...
export function getMessageByErrorCode(
  ...
  switch (errorCode) {
    ...
    case 'rate_limit:billing':
      return 'Your current plan has reached its token budget.';
    case 'forbidden:billing':
      return 'Your current plan does not include this model.';
    case 'forbidden:account':
      return 'Your account is currently disabled or restricted. Please contact support.';
    case 'service_unavailable:billing':
      return 'We could not verify your plan right now. Please try again.';
    case 'not_found:chat':
